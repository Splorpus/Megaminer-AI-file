...
class AI(BaseAI):
    ...
    def run_turn(self) -> bool:
        ...
        #Yandere dev would be proud of all my IF statements
        ...
        if self.game.current_turn % 2 == 1:
            corner = 1
        elif self.game.current_turn % 2 == 0:
            corner = 0
        ...
        if corner == 0:
            if stupidcount == 0:
                ...
                # Wait for a good chance to use the health potion, or for enough of a delay for it to respawn 
                if stressed == 0:
                    ...
                    if self.player.wizard.health<=7:
                        ...
                        #print("I'm stressed...")
                        # Just happily waiting... all on my own... Hopefully without my path unblocked...
                        return True
            elif stupidcount == 3:
                self.player.wizard.move(self.player.wizard.tile.tile_west)
                self.player.wizard.move(self.player.wizard.tile.tile_west)
                ...
                stressed = 1
                return True
                #The power of stupididy is unparalleled.  Hopefully they aren't going to get in my way.
        if corner == 1:
            if stupidcount == 0:
                self.player.wizard.move(self.player.wizard.tile.tile_west)
                self.player.wizard.move(self.player.wizard.tile.tile_west)
                ...
                stressed = 1
                return True
                #The power of stupididy is unparalleled.  Now we need to work harder.  I'm scared.

        



        print("Something is wrong, this is the emergency exit case.")
        return True
